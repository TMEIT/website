...
if __name__ == '__main__':
    ...
    K8sDeploymentImageTag("deploy/kubernetes/tmeit-jlh-name/tmeit-app/set_image_tag.json").version = new_semver
    K8sDeploymentImageTag("deploy/kubernetes/tmeit-jlh-name/run-migrations/set_image_tag.json").version = new_semver
